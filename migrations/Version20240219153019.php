 ...
 */
final class Version20240219153019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dechet (id INT AUTO_INCREMENT NOT NULL, idrecyclage_id INT DEFAULT NULL, dechets VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date DATE NOT NULL, source VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, INDEX IDX_53C0FC60DD68BBF2 (idrecyclage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
