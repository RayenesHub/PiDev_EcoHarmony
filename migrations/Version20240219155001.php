 ...
 */
final class Version20240219155001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dechet (id INT AUTO_INCREMENT NOT NULL, idrecyclage_id INT DEFAULT NULL, categrie VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date DATE NOT NULL, source VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, INDEX IDX_53C0FC60DD68BBF2 (idrecyclage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, nom_event VARCHAR(255) NOT NULL, nbr_participants INT NOT NULL, lieux_event VARCHAR(255) NOT NULL, date_event DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, description_event VARCHAR(255) NOT NULL, affiche_event VARCHAR(700) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recyclage (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, emplacement VARCHAR(255) NOT NULL, capacite VARCHAR(255) NOT NULL, responsable VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE dechet ADD CONSTRAINT FK_53C0FC60DD68BBF2 FOREIGN KEY (idrecyclage_id) REFERENCES recyclage (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dechet DROP FOREIGN KEY FK_53C0FC60DD68BBF2');
