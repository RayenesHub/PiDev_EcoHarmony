 ...
 */
class getPlanteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlanteRepository' shared autowired service.
     *
     * @return \App\Repository\PlanteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlanteRepository.php';

        return $container->privates['App\\Repository\\PlanteRepository'] = new \App\Repository\PlanteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
