 ...
 */
class getReserveRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReserveRepository' shared autowired service.
     *
     * @return \App\Repository\ReserveRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReserveRepository.php';

        return $container->privates['App\\Repository\\ReserveRepository'] = new \App\Repository\ReserveRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
