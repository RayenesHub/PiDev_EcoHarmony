 ...
 */
class getNappeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NappeRepository' shared autowired service.
     *
     * @return \App\Repository\NappeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NappeRepository.php';

        return $container->privates['App\\Repository\\NappeRepository'] = new \App\Repository\NappeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
