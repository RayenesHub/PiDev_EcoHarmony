 ...
 */
class getPuitsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PuitsRepository' shared autowired service.
     *
     * @return \App\Repository\PuitsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PuitsRepository.php';

        return $container->privates['App\\Repository\\PuitsRepository'] = new \App\Repository\PuitsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
